  ...
  return (
    <div className=" relative">
        ...
        <div className="mt-24 grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 lg:grid-cols-12 xl:gap-x-8">
          ...
          <div className='col-span-6'>
            <img
              ...
              alt="Crypto-Logo"
            />
            <h3 className='text-lightblue text-sm font-normal leading-9 mb-4 lg:mb-16'> Verifi-dapp that are digitally  verifies your identity.</h3>
      ...
      <div className='py-8 px-4 border-t border-t-lightblue'>
        <h3 className='text-center text-offwhite'>@2023 - All Rights Reserved by <Link href="https://adminmart.com/" target="_blank">GRIFFINDORS</Link></h3>
      </div>
